...
import com.example.library00.book.service.IBookService;
...
public class BookController {
    ...
    public Object add(@RequestBody Book book){
        boolean flag = iBookService.addBook(book);
        if(flag)
...
//    }
    ...
    public Object findBookName(@RequestParam String bookName){
        ArrayList<Book> bookList = iBookService.queryBook(bookName);
    ...
    public Object matchBook(@RequestParam String searchWord){
        int bookCount = iBookService.matchBook(searchWord);
    ...
    public Object allBooks(){
        ArrayList<Book> books = iBookService.getAllBooks();
